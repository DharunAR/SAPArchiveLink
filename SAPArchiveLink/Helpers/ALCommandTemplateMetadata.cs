namespace SAPArchiveLink.Helpers
{
    ...
    {
        private static readonly Dictionary<ALCommandTemplate, (char AccessMode, string HttpMethod)> _metadata = new()
    {
        ...
        public static char GetAccessMode(ALCommandTemplate template)
        {
