namespace SAPArchiveLink
{
    public interface IBaseServices
    {
        ...
        Task<ICommandResponse> CreateRecord(CreateSapDocumentModel createSapDocumentModel, bool isMultipart = false);
        ...
        Task<ICommandResponse> UpdateRecord(CreateSapDocumentModel createSapDocumentModel, bool isMultipart = false);
        ...
        Task<ICommandResponse> GetAttrSearchResult(SapSearchRequestModel searchRequest);
    }
}
