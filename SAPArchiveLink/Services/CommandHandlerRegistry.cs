namespace SAPArchiveLink
{
    public class CommandHandlerRegistry : ICommandHandlerRegistry
    {
        ...
        // Static map to avoid re-discovering types every time
        private static readonly Dictionary<ALCommandTemplate, Type> _handlerMap = new()
        {
    ...
    { ALCommandTemplate.GETCONTENT, typeof(GetContentCommandHandler) },
        ...
        {
            if (_handlerMap.TryGetValue(template, out var handlerType))
            {
